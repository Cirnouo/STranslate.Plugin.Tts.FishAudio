...
> [!TIP]
> S2.1 Pro 모델은 `2026-08-31` UTC 종료 시점까지 기간 한정으로 무료입니다. 플러그인에서 `s2.1-pro-free` 모델을 선택해 사용합니다. 자세한 내용: [Fish Audio S2.1 Pro: Free Text-to-Speech API for Developers](https://fish.audio/blog/s2-1-pro-free-api/)
