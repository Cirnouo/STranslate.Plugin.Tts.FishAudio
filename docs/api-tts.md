...
> `model` 是自定义 HTTP header，不在请求体中。`s2.1-pro-free` 在 `2026-09-01T00:00:00Z` 前可用，即覆盖 `2026-08-31` UTC 全日；之后推荐使用 `s2.1-pro`。
...
| 模型 | 情绪语法 | 多说话人 | 语言数 | 说明 |
|:--|:--|:--:|:--:|:--|
| `s2.1-pro-free` | `[自然语言]` | 支持 | 80+ | 限时免费，`2026-08-31` UTC 全日可用，`2026-09-01T00:00:00Z` 起不可用 |
