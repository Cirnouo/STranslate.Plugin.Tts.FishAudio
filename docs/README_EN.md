...
| Synthesis model | `s2.1-pro-free` during the free period, then `s2.1-pro` | Through 2026-08-31 UTC: `s2.1-pro-free`, `s2.1-pro`, `s2-pro`, `s1`; starting 2026-09-01 UTC, the free model is hidden. |
