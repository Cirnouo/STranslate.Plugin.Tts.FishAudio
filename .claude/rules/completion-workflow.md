...
- Update `CHANGELOG.md`, `docs/DESIGN_DECISIONS.md`, applicable locale files, and `AGENTS.md` whenever behavior or user-facing text changes. `CLAUDE.md` imports `AGENTS.md` through `@AGENTS.md` and must not duplicate the shared instructions.
